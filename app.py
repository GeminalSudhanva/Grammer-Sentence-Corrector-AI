...
# Function to process the paragraph and correct each sentence
...
with col1:
    ...
    input_text = st.text_area("", height=200, placeholder="Type or paste your text here...", key="input_area")
...
with col2:
    ...
    - You can paste text from any source
    - The correction process is instant
